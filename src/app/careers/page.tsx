    ...
    <main style={{ background: 'var(--white)', minHeight: '100vh' }}>
      ...
      <div className="container" style={{ padding: '100px 20px', maxWidth: 800 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 30, color: 'var(--text-secondary)' }}>
          <p>Join the RADHANA Clothing team! We are always looking for passionate individuals who share our love for elegance and style.</p>
          <p>Currently, we don't have any open positions, but feel free to send your resume to careers@radhanaclothing.com</p>
        </div>
      </div>
      <Footer />
    </main>
