        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: 80, alignItems: 'center' }}>
            ...
            >
              ...
              <p style={{ 
                ...
                RADHANA Klothing was born from a vision — to redefine contemporary style through timeless elegance and uncompromising quality. What began as a humble idea, crafted with passion and precision, has evolved into a brand that celebrates sophistication in every detail.
              </p>
            </motion.div>
            ...
            >
              <div style={{ position: 'relative', zIndex: 1 }}>
                ...
                <p style={{ fontSize: '1.15rem', lineHeight: 2, color: 'var(--text-secondary)' }}>
                  Today, RADHANA Klothing proudly extends its presence across Ratlam, Dhar, and Manasa, with each store reflecting our commitment to excellence and our journey of growth.
                </p>
              </div>
          ...
          >
            ...
            <p style={{ fontSize: '1.2rem', lineHeight: 2, opacity: 0.8, maxWidth: 800, margin: '0 auto', position: 'relative', zIndex: 1 }}>
              More than a fashion label, RADHANA Klothing is a statement — of confidence, grace, and individuality. We believe style is not just worn, but experienced.
            </p>
          </motion.div>
